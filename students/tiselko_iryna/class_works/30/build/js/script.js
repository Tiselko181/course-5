...
var nav = document.getElementById('menu'); // id- the best & quick result
// console.log(nav);
...
var menuSpans = _toConsumableArray(document.querySelectorAll('.menu_item .menu_link > span')); // 
// console.log(menuSpans);

var menu = nav.querySelector('.menu');
var menuItems = _toConsumableArray(menu.querySelectorAll('.menu > li'));
// console.log(menuItems);
